...
const Header = ({agregarCarrito, cartItems, quitarCarrito}) => {
            ...
            <nav className='navegacion'>
                ...
                <ul className='ulNavegacion'> 
                    ...
                    <li className='cartnav'>
                        ...
                        <Cart  agregarCarrito={agregarCarrito} quitarCarrito={quitarCarrito} cartItems={cartItems} isOpen={isCartOpen} onClose={()=>
                        setCartOpen(false)}/>
                    </li>
                </ul>
